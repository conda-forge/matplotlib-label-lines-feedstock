...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/matplotlib-label-lines-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13580&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/matplotlib-label-lines-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `matplotlib-label-lines` can be installed with:

```
conda install matplotlib-label-lines
```

It is possible to list all of the versions of `matplotlib-label-lines` available on your platform with:
